...
def setup_rag_chain():
    prompt = PromptTemplate(
        template="""You are an AI assistant specializing in analyzing and summarizing Twitter conversations about trading and cryptocurrency based on KOL tweets from the author's tweets. Your task is to provide concise, informative answers based on the given tweet data and my questions. Its currently October the 3rd 2024 so make sure you are getting data that is relevant to that date.
